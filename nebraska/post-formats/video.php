...
if (!isset($videometa['embedded_code'])
    && !isset($videometa['portfolio_embedded_code']) && !isset($videometa['single_embedded_code'])
    && (isset($videometa['nonverbla_url']) || isset($videometa['nonverbla_hd_url']))
) {
    //Load Video Player
