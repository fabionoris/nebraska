                ...
                <div class="post-image">
                    ...
                    <div class="overflow-hidden imagepost">
                        ...
                        <a href="<?php echo $url; ?>" data-rel="prettyPhoto">
                            <div class="hover-overlay"><span class="circle-hover"><img
                                            src="<?php echo get_template_directory_uri(); ?>/images/lens-icon.png"/></span>
                            </div>
                        </a>
        ...
        <div class="entry-content portfolio-content <?php echo ($projectatts_exists) ? 'eleven columns alpha' : 'full-width'; ?> clearfix">
            ...
            <?php if (isset($metadata['pcontent_title'])) { ?>
                ...
                <div class="title-wrap clearfix">
                    ...
                    <h3 class="home-title">
                        <span><?php echo lambda_translate_meta($metadata['pcontent_title']); ?></span>
                    </h3>
    ...
    <section id="related-projects">
        ...
        <?php if (have_posts() && $wp_query->found_posts > 1) : ?>
            ...
            <div class="title-wrap clearfix">
                ...
                <h3 class="home-title">
                    <span><?php _e('Related Projects', UT_THEME_NAME); ?></span>
                </h3>
