        ...
        <td colspan="6">
            <form method="post" action="?page=view_tables&add=1" class="form-horizontal">
                ...
                <div class="controls">
                    ...
                    <input type="text" id="table_name" class="lambda_input" name="table_name" size="70"
                           placeholder="<?php _e('Table Name', UT_THEME_NAME); ?>"/>
                    <button type="submit" class="btn btn-success" value="<?php _e('Add new Table', UT_THEME_NAME); ?>"/>
                ...
                <span class="info">
                    <?php _e('* Do not use spaces or special characters in the name. This Name is only for internal use!', UT_THEME_NAME); ?>
                </span>
                        ...
                        <div id="lambda_<?php echo $key; ?>" class="column_item">
                            ...
                            <div class="lambda_row">
                                ...
                                <div class="btn-group" data-toggle="buttons-radio">
                                    ...
                                    <button value="<?php echo $key; ?>_on" type="button"
                                            class="btn btn-mini btn-info <?php echo ($value['column_active'] == 'on') ? 'active' : 'inactive'; ?> radio_<?php echo ($value['column_active'] == 'on') ? 'active' : 'inactive'; ?>"><?php _e('on', UT_THEME_NAME); ?></button>
                                    <button value="<?php echo $key; ?>_off" type="button"
                                            class="btn btn-mini btn-info <?php echo ($value['column_active'] == 'off') ? 'active' : 'inactive'; ?> radio_<?php echo ($value['column_active'] == 'off') ? 'active' : 'inactive'; ?>"><?php _e('off', UT_THEME_NAME); ?></button>

                                    <input class="radiostate_<?php echo ($value['column_active'] == 'on') ? 'active' : 'inactive'; ?>"
                                           style="display:none;" id="<?php echo $key; ?>_on" type="radio"
                                           name="<?php echo $table; ?>[columns][<?php echo $key; ?>][column_active]"
                                           value="on" <?php echo ($value['column_active'] == 'on') ? 'checked="checked"' : ''; ?> /><br/>
                                    <input class="radiostate_<?php echo ($value['column_active'] == 'off') ? 'active' : 'inactive'; ?>"
                                           style="display:none;" id="<?php echo $key; ?>_off" type="radio"
                                           name="<?php echo $table; ?>[columns][<?php echo $key; ?>][column_active]"
                                           value="off" <?php echo ($value['column_active'] == 'off') ? 'checked="checked"' : ''; ?> /><br/>
                            ...
                            <div class="lambda_row">
                                ...
                                <div class="btn-group" data-toggle="buttons-radio">
                                    ...
                                    <button value="<?php echo $key; ?>_yes" type="button"
                                            class="btn btn-mini btn-info <?php echo ($value['featured'] == 'yes') ? 'active' : 'inactive'; ?> radio_<?php echo ($value['featured'] == 'yes') ? 'active' : 'inactive'; ?>"><?php _e('yes', UT_THEME_NAME); ?></button>
                                    <button value="<?php echo $key; ?>_no" type="button"
                                            class="btn btn-mini btn-info <?php echo ($value['featured'] == 'no') ? 'active' : 'inactive'; ?> radio_<?php echo ($value['featured'] == 'no') ? 'active' : 'inactive'; ?>"><?php _e('no', UT_THEME_NAME); ?></button>

                                    <input class="radiostate_<?php echo ($value['featured'] == 'yes') ? 'active' : 'inactive'; ?>"
                                           style="display:none;" id="<?php echo $key; ?>_yes" type="radio"
                                           name="<?php echo $table; ?>[columns][<?php echo $key; ?>][featured]"
                                           value="yes" <?php echo ($value['featured'] == 'yes') ? 'checked="checked"' : ''; ?> /><br/>
                                    <input class="radiostate_<?php echo ($value['featured'] == 'no') ? 'active' : 'inactive'; ?>"
                                           style="display:none;" id="<?php echo $key; ?>_no" type="radio"
                                           name="<?php echo $table; ?>[columns][<?php echo $key; ?>][featured]"
                                           value="no" <?php echo ($value['featured'] == 'no') ? 'checked="checked"' : ''; ?> /><br/>
                            ...
                            <input style="width:148px !important; min-width: inherit !important;"
                                   id="<?php echo $key; ?>" type="text"
                                   name="<?php echo $table; ?>[columns][<?php echo $key; ?>][column_head]"
                                   value="<?php echo $value['column_head']; ?>"/><br/>
                            ...
                            <input style="width:148px !important; min-width: inherit !important;"
                                   id="<?php echo $key; ?>" type="text"
                                   name="<?php echo $table; ?>[columns][<?php echo $key; ?>][column_price]"
                                   value="<?php echo $value['column_price']; ?>"/><br/>
                            ...
                            <input style="width:148px !important; min-width: inherit !important;"
                                   id="<?php echo $key; ?>" type="text"
                                   name="<?php echo $table; ?>[columns][<?php echo $key; ?>][column_curr]"
                                   value="<?php echo $value['column_curr']; ?>"/><br/>
                            ...
                            <input style="width:148px !important; min-width: inherit !important;"
                                   id="<?php echo $key; ?>" type="text"
                                   name="<?php echo $table; ?>[columns][<?php echo $key; ?>][column_time]"
                                   value="<?php echo $value['column_time']; ?>"/><br/>
                            ...
                            <div id="features_<?php echo $key; ?>">
                                ...
                                <?php foreach ($value['column_content'] as $x => $feature) { ?>
                                    ...
                                    <div class="feature_item">
                                        <input style="width:115px !important; min-width: inherit !important;"
                                               class="feature" id="feature_<?php echo $x; ?>" type="text"
                                               name="<?php echo $table; ?>[columns][<?php echo $key; ?>][column_content][<?php echo $x; ?>]"
                                               value="<?php echo $value['column_content'][$x]; ?>"/><br/>
                                        <button type="button" class="btn btn-mini btn-danger remove-feature"><i
                            ...
                            <button data-key="<?php echo $key; ?>" data-table="<?php echo $table; ?>" type="button"
                                    value="features_<?php echo $key; ?>"
                                    class="add_column_feature right btn btn-mini btn-info" name="<?php echo $table; ?>">
                                <i class="icon-picture icon-white"></i> <?php _e('Add Row', UT_THEME_NAME); ?></button>
                            ...
                            <input style="width:148px !important; min-width: inherit !important;"
                                   id="<?php echo $key; ?>" type="text"
                                   name="<?php echo $table; ?>[columns][<?php echo $key; ?>][column_url]"
                                   value="<?php echo $value['column_url']; ?>"/><br/>
                            ...
                            <input style="width:148px !important; min-width: inherit !important;"
                                   id="<?php echo $key; ?>" type="text"
                                   name="<?php echo $table; ?>[columns][<?php echo $key; ?>][column_buttontext]"
                                   value="<?php echo $value['column_buttontext']; ?>"/><br/>
