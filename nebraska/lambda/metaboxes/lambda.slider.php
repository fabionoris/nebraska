                    ...
                    <div class="slider_type_details">
                        ...
                        <select name="<?php $mb->the_name(); ?>" id="sliderstyle_type">
                            <?php foreach ($slidertype as $key => $value) {
                                echo '<option value="' . $key . '" ' . $mb->get_the_select_state($key) . '>' . $value . '</option>';
                            } ?>
                        </select>
                        ...
                        <div id="static_image" class="ss_box">
                            ...
                            <div class="lambda-settings-pad">
                                ...
                                <label><?php _e('Static Image', UT_THEME_NAME); ?></label><span
                                        class="badge badge-info"><?php _e('This Image should be at least 980px wide', UT_THEME_NAME); ?></span>
                                <br/><br/>
                                ...
                                <div class="btn-group" style="margin-bottom:15px;">
                                    ...
                                    <button data-state="static_image_size_on"
                                            class="btn <?php echo $activestate; ?> radio_active" type="button"
                                            value="on"><?php _e('centered', UT_THEME_NAME); ?></button>
                                    <input id="static_image_size_on" type="radio" value="on"
                                           name="<?php $mb->the_name(); ?>" style="display:none;"
                                           class="radiostate_active" <?php $mb->the_radio_state('on'); ?>>
                                    <button data-state="static_image_size_off"
                                            class="btn <?php echo $deactivestate; ?> radio_inactive" type="button"
                                            value="off"><?php _e('fullwidth', UT_THEME_NAME); ?></button>
                                    <input id="static_image_size_off" type="radio" value="off"
                                           name="<?php $mb->the_name(); ?>" style="display:none;"
                        ...
                        <div id="static_video" class="ss_box">
                            ...
                            <div class="lambda-settings-pad">
                                ...
                                <p>
                                    ...
                                    <?php echo $wpalchemy_media_access->getField(array('name' => $mb->get_the_name(), 'value' => $mb->get_the_value())); ?>
                                    <br/><span
                                            class="info badge badge-info">(<?php _e('can be .mov, .flv', UT_THEME_NAME); ?>)</span><br/>
                                    <?php echo $wpalchemy_media_access->getButton(); ?>
                                </p>
                                ...
                                <p>
                                    ...
                                    <?php echo $wpalchemy_media_access->getField(array('name' => $mb->get_the_name(), 'value' => $mb->get_the_value())); ?>
                                    <br/><span
                                            class="info badge badge-info">(<?php _e('should be same size as Video', UT_THEME_NAME); ?>)</span><br/>
                                    <?php echo $wpalchemy_media_access->getButton(); ?>
                                </p>
                                ...
                                <p>
                                    ...
                                    <?php echo $wpalchemy_media_access->getField(array('name' => $mb->get_the_name(), 'value' => $mb->get_the_value())); ?>
                                    <br/><span
                                            class="info badge badge-info">(<?php _e('The URL to .mp4 video file for Ipad', UT_THEME_NAME); ?>)</span><br/>
                                    <?php echo $wpalchemy_media_access->getButton(); ?>
                                </p>
                                ...
                                <p>
                                    ...
                                    <br/><span
                                            class="info badge badge-info">(<?php _e('Embedded Code', UT_THEME_NAME); ?>)</span>
                                </p>
                        ...
                        <div id="static_textvideo" class="ss_box">
                            ...
                            <div class="lambda-settings-pad">
                                ...
                                <p>
                                    <label><?php _e('Headline', UT_THEME_NAME); ?></label>
                                    ...
                                    jQuery(document).ready(function ($) {
                                        $('#featured_headline_color').ColorPicker({
                                            ...
                                            onChange: function (hsb, hex, rgb) {
                                                $('#featured_headline_color').val('#' + hex);
                                                $('#cp_featured_headline_color div').css({
                                                    'backgroundColor': '#' + hex,
                                                    'borderColor': '#' + hex
                                                });
                                ...
                                <div class="colorform">
                                    ...
                                    <div id="cp_featured_headline_color" class="cp_box box_style_2">
                                        <div style="background-color:<?php echo (!is_null($mb->get_the_value())) ? $mb->get_the_value() : '#ffffff'; ?>;<?php if (!is_null($mb->get_the_value())) {
                                            echo 'border-color:' . $mb->get_the_value() . ';';
                                        } ?>">
                                        </div>
                                    </div>

                                    <label class="cp_box_label"><?php _e('Headline Color', UT_THEME_NAME); ?></label>
                                    <input id="featured_headline_color" type="text" name="<?php $mb->the_name(); ?>"
                                           value="<?php $mb->the_value(); ?>"/>
                                </div>


                                <p>
                                    <label><?php _e('Text', UT_THEME_NAME); ?></label>
                                ...
                                <script type="text/javascript">
                                    ...
                                    jQuery(document).ready(function ($) {
                                        $('#featured_text_color').ColorPicker({
                                            ...
                                            onChange: function (hsb, hex, rgb) {
                                                $('#featured_text_color').val('#' + hex);
                                                $('#cp_featured_text_color div').css({
                                                    'backgroundColor': '#' + hex,
                                                    'borderColor': '#' + hex
                                                });
                                ...
                                <div class="colorform">
                                    ...
                                    <input id="featured_text_color" type="text" name="<?php $mb->the_name(); ?>"
                                           value="<?php $mb->the_value(); ?>"/>

                                </div>

                                <p>
                                    <label><?php _e('Buttontext', UT_THEME_NAME); ?></label>
                                ...
                                <p>
                                    <label><?php _e('Buttonlink', UT_THEME_NAME); ?></label>
            ...
            <div class="slider_type_background ten columns">
                ...
                <div class="lambda-opttitle">
                    <div class="lambda-opttitle-pad">
                        ...
                        <br/>
                        <span>(<?php _e('This will hide the page title, but the title is still visible for search engines!', UT_THEME_NAME); ?>)</span>
                    </div>
                </div>
                ...
                <div class="lambda-settings-pad">
                    ...
                    <div class="btn-group" style="height:40px;">
                        ...
                        <button data-state="hide_teaser_on" class="btn <?php echo $activestate; ?> radio_active"
                                type="button" value="teaseron"><?php _e('show', UT_THEME_NAME); ?></button>
                        <input id="hide_teaser_on" type="radio" value="teaseron" name="<?php $mb->the_name(); ?>"
                               style="display:none;"
                               class="radiostate_active" <?php $mb->the_radio_state('teaseron'); ?>>
                        <button data-state="hide_teaser_off" class="btn <?php echo $deactivestate; ?> radio_inactive"
                                type="button" value="teaseroff"><?php _e('hide', UT_THEME_NAME); ?></button>
                        <input id="hide_teaser_off" type="radio" value="teaseroff" name="<?php $mb->the_name(); ?>"
                               style="display:none;"
                               class="radiostate_inactive" <?php $mb->the_radio_state('teaseroff'); ?>>
                    ...
                    <p>
                        ...
                        <textarea name="<?php $mb->the_name(); ?>" rows="8" cols="75"
                                  class="lambdatextarea"><?php $mb->the_value(); ?></textarea>
                        <br/>
                        <span class="info badge badge-info">(<?php _e('Display an individual Page Title', UT_THEME_NAME); ?>)</span>
                    </p>
                    ...
                    <p>
                        ...
                        <textarea name="<?php $mb->the_name(); ?>" rows="8" cols="75"
                                  class="lambdatextarea"><?php $mb->the_value(); ?></textarea>
                        <br/>
                        <span class="info badge badge-info">(<?php _e('Display an inidividual text beneath the page title', UT_THEME_NAME); ?>)</span>
                    </p>
                ...
                <div class="lambda-settings-pad">
                    ...
                    <div id="slider_default_backgroundimage" class="sbg_box">
                        ...
                        <script type="text/javascript">
                            ...
                            jQuery(document).ready(function ($) {
                                $('#slider_solid_backgroundcolor').ColorPicker({
                                    ...
                                    onChange: function (hsb, hex, rgb) {
                                        $('#slider_solid_backgroundcolor').val('#' + hex);
                                        $('#cp_slider_solid_backgroundcolor div').css({
                                            'backgroundColor': '#' + hex,
                                            'borderColor': '#' + hex
                                        });
                        ...
                        <input id="slider_solid_backgroundcolor" type="text" name="<?php $mb->the_name(); ?>"
                               value="<?php $mb->the_value(); ?>"/>
                        </p>
