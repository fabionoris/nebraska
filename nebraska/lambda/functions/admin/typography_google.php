        ...
        <div class="section">
            <div class="element">
                ...
                <div class="select_googlefont">
                    ...
                    <input type="text" name="<?php echo $value->item_id; ?>[font-family]"
                           id="<?php echo $value->item_id; ?>"
                           value="<?php echo (isset($settings[$value->item_id]['font-family'])) ? stripslashes($settings[$value->item_id]['font-family']) : ''; ?>"
                           class="cp_input"/>
                </div>
