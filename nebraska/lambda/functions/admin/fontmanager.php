    ...
    <div class="option option-option-tree-fontmanager">
        ...
        <div class="section">
            <div class="element">
                ...
                <a href="#" id="<?php echo $value->item_id; ?>" class="btn btn-success light add-font right">Add
                    Font</a>
        ...
        <div class="option-tree-fontmanager-body fontmanager">
                ...
                if ($field['type'] == 'font' || $field['name'] == 'font') { ?>
                    <div class="singlefont">
                        ...
                        <input type="text"
                               ...
                               value="<?php echo(isset($font[$field['name']]) ? stripslashes($font[$field['name']]) : ''); ?>"
                               class="upload<?php if (isset($font[$field['name']])) {
                                   echo ' has-file';
                               } ?>"/>
                        <input id="upload_<?php echo $id ?>-<?php echo $count ?>-<?php echo $field['name'] ?>"
                               class="upload_button btn btn-mini btn-success" type="button" value="Upload"
                               rel="<?php echo $int; ?>"/>
                    </div>
                    <?php
          ...
          <p>
            ...
            <div class="fontshortcode">
                [font face="<?php echo $font['title']; ?>" size="24" weight="normal" color="#006699"
                style="italic"] <?php echo $font['title']; ?> [/font]
            </div>
