        ...
        <div class="section">
            <div class="element">
                ...
                <div class="select_wrapper">
                    ...
                    <input style="width:175px;" type="text" name="<?php echo $value->item_id; ?>[font-color]"
                           id="<?php echo $value->item_id; ?>-picker"
                           value="<?php echo (isset($settings[$value->item_id]['font-color'])) ? stripslashes($settings[$value->item_id]['font-color']) : ''; ?>"
                           class="cp_input"/>
