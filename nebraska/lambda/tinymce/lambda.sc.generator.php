...
<head>
    ...
    <script type="text/javascript"
            src="<?php echo get_option('siteurl') ?>/wp-includes/js/jquery/jquery-migrate.min.js"></script>
            ...
            $('.cp, .color').live('click', function () {
                ...
                $this.ColorPicker({
                    ...
                    onShow: function (colpkr) {
                        $(colpkr).show().css('z-index', $('#TB_window').css('z-index') + 1);
                        return false;
                    },
...
<div class="bootstrap-wpadmin">
    ...
    <div class="lambda-settings-pad">
        ...
        <code class="shortcode_prev"><span id="shortcode-preview-o" style=""></span><span
                    id="shortcode-preview-m"></span><span id="shortcode-preview-c" style=""></span></code>

    </div>

    <input class="btn btn-success" id="insert-shortcode" value="<?php _e('Insert Shortcode', UT_THEME_NAME); ?>"
           type="button">
    <div class="clear"></div>
