...
// Deprecated, use WPALCHEMY_FIELD_HINT_SELECT_MULTI instead
...
class WPAlchemy_MetaBox
{
    ...
    function _import($post_id, $key, $value)
    {
        if (WPALCHEMY_MODE_ARRAY == $this->mode and $key == $this->id) {
            ...
            // Maybe unserialize fixes a wordpress bug which double serializes already serialized data during export/import
