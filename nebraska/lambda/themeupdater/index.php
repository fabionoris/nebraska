...
function lambda_view_info()
{
    ...
    <div class="alert alert-success">
        ...
        <ul>
            ...
            <li>Theme Version: <?php echo UT_THEME_VERSION; ?> Fixed</li>
            <li>Framework Version: <?php echo UT_LAMBDA_VERSION; ?> Fixed</li>
    ...
    <div class="well">
        ...
        <form method="post" action="?page=view_info&changecr=true" class="form-horizontal">
            ...
            <p><label class="control-label"><?php _e('Copyright', UT_THEME_NAME); ?></label>
                <input style="margin-left:20px;" type="text" id="option_name" class="lambda_input" name="copyright"
                       size="70" value="<?php echo $copyright; ?>"/></p>

            <p><label class="control-label"><?php _e('Copyrightlink', UT_THEME_NAME); ?></label>
                <input style="margin-left:20px;" type="text" id="option_name" class="lambda_input" name="copyrightlink"
                       size="70" value="<?php echo $copyrightlink; ?>"/></p>

            <button style="float:right;" type="submit" class="btn" value="Add new"/>
            <?php _e('change', UT_THEME_NAME); ?></button>
