        ...
        if (is_array($boxmetadata['lambda_page_item']))
            ...
            foreach ($boxmetadata['lambda_page_item'] as $singlebox) {
                ...
                if (isset($singlebox['box_type'])) :
                    ...
                    switch ($singlebox['box_type']) {
                        ...
                        case "testimonialcarousel":
                            render_testimonial_carousel($singlebox, '', $counter, 'page');
                            break;

                        case "blog_excerpt":
                            render_lambda_blog($singlebox, false);
                            break;

                        case "sidebarwidget":
                            render_simple_sidebar($singlebox, $gridsize);
                            break;
                ...
                if ($gridsize == "960") {
                    ...
                    if ($last == 960 && (isset($singlebox['box_type']) && $singlebox['box_type'] != 'row')) {
