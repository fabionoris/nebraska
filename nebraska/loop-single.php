                ...
                <div class="author-links clearfix">
                    ...
                    <ul class="lambda-sociallinks clearfix">
                        ...
                        <?php if (get_the_author_meta('user_url', $author_id)) : ?>
                            ...
                            <li><a class="link" href="<?php the_author_meta('user_url', $author_id); ?>"
                                   target="_blank"></a></li>
                        ...
                        <?php if (get_the_author_meta('facebook', $author_id)) : ?>
                            ...
                            <li><a class="facebook" href="<?php the_author_meta('facebook', $author_id); ?>"
                                   target="_blank"></a></li>
                        ...
                        <?php if (get_the_author_meta('twitter', $author_id)) : ?>
                            ...
                            <li><a class="twitter" href="<?php the_author_meta('twitter', $author_id); ?>"
                                   target="_blank"></a></li>
                        ...
                        <?php if (get_the_author_meta('aim', $author_id)) : ?>
                            ...
                            <li><a class="aim" href="<?php the_author_meta('aim', $author_id); ?>" target="_blank"></a>
                            </li>
                        ...
                        <?php if (get_the_author_meta('email', $author_id)) : ?>
                            ...
                            <li><a class="email" href="mailto:<?php the_author_meta('email', $author_id); ?>"
                                   target="_blank"></a></li>
